#!/bin/bash
# Script to run S4 Hybrid-Batch 5 times (Batch sizes: 10, 15, 20, 25, 30) at TPS 100
...
for b in "${BATCHES[@]}"; do
    echo -e "\n\n============================================="
    echo "  Running Scenario 4 - TPS 100 - Batch Size $b"
    echo "============================================="
    
    # Determine the configuration file based on batch size
    if [ "$b" -eq 10 ]; then
        CONFIG="All_benchmarks/hybrid-batch/bcms-s-hybrid-batch-tps100.yaml"
    else
        CONFIG="All_benchmarks/hybrid-batch/bcms-s-hybrid-batch${b}-tps100.yaml"
    fi
    ...
    OUT_DIR="../results/40run_M4/tps100/batch${b}"
...
echo -e "\n============================================="
echo " 🎉 All 5 Batch scenarios completed successfully!"
echo "============================================="
