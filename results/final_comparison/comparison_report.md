...
> Generated: 2026-05-01 02:36:40  |  Caliper 0.6.0  |  Fabric 2.5.9
...
| **BLAKE3 Alternative** | `blake3` | 1 | 4 | 30.2 | 30.2 | 101430 | 27,322 | **4252** | **84.4%** | **+0.0%** |
| **Hybrid SHA-256 + BLAKE3** | `hybrid` | 1 | 4 | 30.2 | 30.2 | 101430 | 27,322 | **4252** | **84.4%** | **+0.0%** |
| **Hybrid + Batching ×10** | `hybrid` | 10 | 8 | 30.2 | 302.0 | 101430 | 27,322 | **4252** | **84.4%** | **+0.0%** |

## Key Improvement: S1 → S4

| Metric | S1 | S4 | Change |
|:--|--:|--:|--:|
| IssueCert TPS | 30.2 | 30.2 | **+0.0%** |
| Eff. Cert TPS | 30.2 | 302.0 | **+900.0%** |
| Avg Latency (ms) | 101430 | 101430 | **-0.0%** |
